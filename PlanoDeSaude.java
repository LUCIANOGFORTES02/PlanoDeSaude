...
public abstract class PlanoDeSaude {
	...
	public abstract void cadastrarBeneficiario(Beneficiario b) throws BeneficiarioExistenteException, 
	DadosInvalidosException, IdadeInvalidaException;
    ...
    CarenciaException, PeriodicidadeException, UnicidadeException, BeneficiarioInexistenteException, ProcedimentoInexistenteException,BeneficiarioExistenteException;
